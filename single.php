		...
		<div class="row">
            ...
            <section id="main" class='<?php echo ($sidebar == 'single') ? 'col-md-12' : 'col-md-8'; ?>'>
				...
				<article>
					<div class="kratos-hentry kratos-post-inner clearfix">
						<header class="kratos-entry-header">
							...
							<div class="kratos-post-meta text-center">
								<span>
								<i class="fa fa-calendar"></i> <?php echo get_the_date(get_the_time('Y-m-d G:i')); ?>
					...
					<div class="kratos-hentry kratos-copyright text-center clearfix yuancwenz">
						<!-- <img alt="知识共享许可协议" src="<?php echo get_template_directory_uri(); ?>/images/licenses.png"> -->
						<!-- <h5>本作品采用 <a rel="license nofollow" target="_blank" href="http://creativecommons.org/licenses/by-sa/4.0/">知识共享署名-相同方式共享 4.0 国际许可协议</a> 进行许可</h5> -->
						<h5>本文为博主原创文章，知识共享，开源精神，转载注明出处。</h5>
